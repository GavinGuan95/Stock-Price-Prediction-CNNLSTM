...
svc_g = SVC()
svc_searched = RandomizedSearchCV(svc_g, parameters, cv = 5, n_iter = 10, verbose=0, n_jobs = -1)
...
print(accuracy_score(y_tr, svc_pred_tr))
svc_pred_val = svc_predict.predict(x_te)
print(accuracy_score(y_te, svc_pred_val))
